        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-sm rounded-[32px] bg-white p-6 shadow-2xl border border-slate-100 space-y-6 text-center animate-in fade-in zoom-in duration-200">
            ...
            <div className="mx-auto w-48 h-48 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center overflow-hidden p-2">
              <img 
                src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(`upi://pay?pa=test@upi&pn=QuickDrop&am=${mockQrOrder.amount / 100}&tn=PoolingBooking_${mockQrOrder.orderId}`)}`}
            ...
            <div className="space-y-2 pt-2">
              <a
                href={`upi://pay?pa=test@upi&pn=QuickDrop&am=${mockQrOrder.amount / 100}&tn=PoolingBooking_${mockQrOrder.orderId}`}
