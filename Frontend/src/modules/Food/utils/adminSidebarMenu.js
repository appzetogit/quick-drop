export const adminSidebarMenu = [
  // Master's screens are in masterSidebarMenu.js: that panel has its own menu.
  {
    type: "section",
    label: "HOME",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Packaging Charges", path: "/admin/food/packaging-charges", icon: "Package" },
