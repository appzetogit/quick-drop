...
const earningAddonHistorySchema = new mongoose.Schema(
    {
        offerId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCEarningAddon', required: true, index: true },
        deliveryPartnerId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCDeliveryPartner', required: true, index: true },
...
export const FoodEarningAddonHistory = mongoose.models.QCEarningAddonHistory || mongoose.model('QCEarningAddonHistory', earningAddonHistorySchema, 'qc_earning_addon_histories');
