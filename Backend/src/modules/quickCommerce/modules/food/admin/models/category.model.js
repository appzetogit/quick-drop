...
const foodCategorySchema = new mongoose.Schema(
    {
         ...
         */
        restaurantId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCRestaurant', index: true, default: undefined },
        createdByRestaurantId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCRestaurant', index: true, default: undefined },
         ...
         */
        zoneId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCZone', index: true, default: undefined },
        /**
         ...
         */
        parentId: { type: mongoose.Schema.Types.ObjectId, ref: 'QCCategory', index: true, default: undefined },
...
export const FoodCategory = mongoose.models.QCCategory || mongoose.model('QCCategory', foodCategorySchema, 'qc_categories');
