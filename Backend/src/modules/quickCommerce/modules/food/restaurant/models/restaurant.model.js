...
const restaurantSchema = new mongoose.Schema(
  {
    ...
    /**
     * 'pharmacy' marks this seller as a medical store rather than a general
     * restaurant/grocery seller -- everything else about the record (auth,
     * approval lifecycle, catalogue, orders) is shared.
     */
    storeType: {
      type: String,
      trim: true,
