...
const settlementSchema = new mongoose.Schema(
    {
        ...
        transactionIds: [{ type: mongoose.Schema.Types.ObjectId, ref: 'QCTransaction' }],
...
export const Settlement = mongoose.models.QCSettlement || mongoose.model('QCSettlement', settlementSchema, 'qc_settlements');
