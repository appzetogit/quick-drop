...
export const FoodChatConversation = mongoose.models.FoodChatConversation || mongoose.model('FoodChatConversation', chatConversationSchema, 'food_chat_conversations');
